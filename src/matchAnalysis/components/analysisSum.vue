...
const usedRole = Object.keys(roles).reduce((a, b) =>
    roles[a] > roles[b] ? a : b,
);
    ...
    <div class="flex flex-col gap-y-2" style="width: 160px">
        ...
        <div class="flex flex-col gap-y-2 mt-2">
            ...
            >
                ...
                <n-tag
                    :bordered="false"
                    style="height: 32px; cursor: default !important"
                    :disabled="true"
                    size="small"
                >
                    {{ match.gameModel }}
            ...
            <div v-else>
                <div class="flex justify-between">
                    ...
                    >
                        <n-avatar :size="48" :src="getImg(champ.champId)" />
                        <n-tag
                            :bordered="false"
                            size="small"
                            class="text-sm"
                ...
                <div
                    class="mt-4 flex flex-row gap-y-3 flex-wrap justify-between"
                >
                    <div
                        class="flex gap-y-2 flex-col"
                        v-for="(pos, index) in posRate"
                    >
                        <n-progress
                            ...
                            :percentage="
                                getPercent(
                                    matchAnalysis.roleCountMap[pos.key],
                                    matchAnalysis.totalChampions,
                                )
                            "
                            :color="
                                pos.key !== usedRole
