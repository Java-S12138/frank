...
<template>
    <n-list v-if="teammateStore.summonerInfo.length !== 0">
        <n-list-item
            v-for="(summoner, index) in teammateStore.summonerInfo"
        ...
        >
            ...
            <div v-if="!teammateStore.isLcuErr">
                <load-match
                    v-if="teammateStore.recentMatchList[index] === undefined"
                />
                <n-space
                    v-else
                ...
                >
                    <n-avatar
                        v-for="img in teammateStore.recentMatchList[
                            index
                        ].slice(0, 6)"
                        :size="32"
                        :src="img.champImgUrl"
            ...
            >
                <n-avatar
                    v-for="img in teammateStore.masteryChampList[index].slice(
                        0,
                        6,
                    )"
                    :size="32"
