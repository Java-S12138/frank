                    ...
                    >
                        ...
                        >
                            <n-space vertical align="center" :size="[0, 10]">
                                <img
                                    :src="getImgUrl(rune.selectedPerkIds[0])"
                                    class="runImg"
                                />
                                <img
                                    :src="getImgUrl(rune.selectedPerkIds[1])"
                                    class="runImg"
                                />
                                <img
                                    :src="getImgUrl(rune.selectedPerkIds[2])"
                                    class="runImg"
                                />
                                <img
                                    :src="getImgUrl(rune.selectedPerkIds[3])"
                                    class="runImg"
                                />
                            </n-space>
                            <n-space vertical align="center" :size="[0, 10]">
                                <img
                                    :src="getImgUrl(rune.selectedPerkIds[4])"
                                    class="runImg"
                                />
                                <img
                                    :src="getImgUrl(rune.selectedPerkIds[5])"
                                    class="runImg"
                                />
                                <div class="flex flex-col">
                                    <img
                                        :src="
                                            getImgUrl(rune.selectedPerkIds[6])
                                        "
                                        class="runImgSondary"
                                    />
                                    <img
                                        :src="
                                            getImgUrl(rune.selectedPerkIds[7])
                                        "
                                        class="runImgSondary"
                                    />
                                    <img
                                        :src="
                                            getImgUrl(rune.selectedPerkIds[8])
                                        "
                                        class="runImgSondary"
                                    />
                                </div>
